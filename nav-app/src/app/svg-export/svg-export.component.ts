...
export class SvgExportComponent implements OnInit {
    ...
    public buildSVG(self?: any, bypassDebounce: boolean = false): void {
        ...
        // track smallest optimal font size for tactics
    ...
    private verticalAlignCenter(self: any, fontSize: any = null) {
        if (self.children && self.children.length > 0) {
            ...
            // transform by half the font size for proper centering
     ...
     * @returns number[] where each number corresponds to a division-center offset
     */
    ...
    public downloadSVG(): void {
        ...
        const svgBlob = new Blob([preface, new XMLSerializer().serializeToString(svgElement)], {type:"image/svg+xml;charset=utf-8"});
