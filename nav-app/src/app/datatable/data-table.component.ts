...
export class DataTableComponent implements AfterViewInit {
     ...
     */
    exportRender(): void {
        let v = this.dataService.getDomain(this.viewModel.domainID).getVersion();
        let viewModelCopy = new ViewModel(this.viewModel.name, this.viewModel.domainID, v, "vm" + this.viewModelsService.getNonce(), this.dataService);
