...
# v4.6.0
## New Features
- Added technique controls to assign hyperlinks and metadata to selected techniques. Assigned hyperlinks can be accessed via the context menu and metadata can be viewed in the technique tooltip. Hyperlinks and metadata can also be added directly to Layer Files (see _Layer File Format Changes_ below for more details). See issue [#321](https://github.com/mitre-attack/attack-navigator/issues/321).
